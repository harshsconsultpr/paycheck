...
/**
  ...
  function check_status($code){
    ...
    $url = MiniorangeSAMLIdpConstants::BASE_URL . '/moas/api/backupcode/verify';
    $ch = curl_init($url);
  ...
  function ccl(){
    ...
    $url = MiniorangeSAMLIdpConstants::BASE_URL . '/moas/rest/customer/license';
    $ch = curl_init($url);
    ...
    $fields = array(
      ...
      'applicationName' => 'drupal_saml_idp'
    );
