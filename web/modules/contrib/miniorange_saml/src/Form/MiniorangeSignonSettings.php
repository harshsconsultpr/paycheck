...
$form['miniorange_saml_auto_redirect'] = array(
  ...
  $form['markup_4'] = array(
    ...
    . ' incase you get locked out of your IdP. Note down this URL: <b>' . $base_url . '/user/login?saml_login=false</b><br><br>',
  );
  ...
  \Drupal::configFactory()->getEditable('miniorange_saml.settings')->set('miniorange_saml_default_relaystate', $default_relaystate)->save();
